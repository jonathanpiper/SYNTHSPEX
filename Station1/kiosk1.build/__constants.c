...
static void _createGlobalConstants( void )
{
    ...
    const_str_plain_rb = UNSTREAM_STRING( &constant_bin[ 1265 ], 2, 1 );
    const_str_plain_int = UNSTREAM_STRING( &constant_bin[ 2108 ], 3, 1 );
    const_str_plain_len = UNSTREAM_STRING( &constant_bin[ 3460 ], 3, 1 );
    const_str_plain_sum = UNSTREAM_STRING( &constant_bin[ 3463 ], 3, 1 );
    const_str_plain_sys = UNSTREAM_STRING( &constant_bin[ 2174 ], 3, 1 );
    const_str_plain_iter = UNSTREAM_STRING( &constant_bin[ 1262 ], 4, 1 );
    const_str_plain_long = UNSTREAM_STRING( &constant_bin[ 3466 ], 4, 1 );
    const_str_plain_name = UNSTREAM_STRING( &constant_bin[ 1779 ], 4, 1 );
    const_str_plain_open = UNSTREAM_STRING( &constant_bin[ 2088 ], 4, 1 );
    const_str_plain_read = UNSTREAM_STRING( &constant_bin[ 1492 ], 4, 1 );
    const_str_plain_repr = UNSTREAM_STRING( &constant_bin[ 2036 ], 4, 1 );
    const_str_plain_site = UNSTREAM_STRING( &constant_bin[ 3470 ], 4, 1 );
    const_str_plain_type = UNSTREAM_STRING( &constant_bin[ 1485 ], 4, 1 );
    const_str_plain_False = UNSTREAM_STRING( &constant_bin[ 3474 ], 5, 1 );
    const_str_plain_level = UNSTREAM_STRING( &constant_bin[ 3479 ], 5, 1 );
    const_str_plain_range = UNSTREAM_STRING( &constant_bin[ 3484 ], 5, 1 );
    const_str_plain_format = UNSTREAM_STRING( &constant_bin[ 3489 ], 6, 1 );
    const_str_plain_locals = UNSTREAM_STRING( &constant_bin[ 3495 ], 6, 1 );
    const_str_plain_xrange = UNSTREAM_STRING( &constant_bin[ 3501 ], 6, 1 );
    const_str_plain___all__ = UNSTREAM_STRING( &constant_bin[ 3507 ], 7, 1 );
    const_str_plain___cmp__ = UNSTREAM_STRING( &constant_bin[ 3514 ], 7, 1 );
    const_str_plain___doc__ = UNSTREAM_STRING( &constant_bin[ 3521 ], 7, 1 );
    const_str_plain_compile = UNSTREAM_STRING( &constant_bin[ 3528 ], 7, 1 );
    const_str_plain_globals = UNSTREAM_STRING( &constant_bin[ 3535 ], 7, 1 );
    const_str_plain_inspect = UNSTREAM_STRING( &constant_bin[ 3542 ], 7, 1 );
    const_str_plain_pylibpd = UNSTREAM_STRING( &constant_bin[ 1765 ], 7, 1 );
    const_str_plain___dict__ = UNSTREAM_STRING( &constant_bin[ 3549 ], 8, 1 );
    const_str_plain___exit__ = UNSTREAM_STRING( &constant_bin[ 3557 ], 8, 1 );
    const_str_plain___file__ = UNSTREAM_STRING( &constant_bin[ 3565 ], 8, 1 );
    const_str_plain___iter__ = UNSTREAM_STRING( &constant_bin[ 3573 ], 8, 1 );
    const_str_plain___main__ = UNSTREAM_STRING( &constant_bin[ 3581 ], 8, 1 );
    const_str_plain___name__ = UNSTREAM_STRING( &constant_bin[ 3589 ], 8, 1 );
    const_str_plain___path__ = UNSTREAM_STRING( &constant_bin[ 3597 ], 8, 1 );
    const_str_plain_callback = UNSTREAM_STRING( &constant_bin[ 1933 ], 8, 1 );
    const_str_plain_exc_type = UNSTREAM_STRING( &constant_bin[ 3605 ], 8, 1 );
    const_str_plain_fromlist = UNSTREAM_STRING( &constant_bin[ 3613 ], 8, 1 );
    const_str_plain___class__ = UNSTREAM_STRING( &constant_bin[ 3621 ], 9, 1 );
    const_str_plain___debug__ = UNSTREAM_STRING( &constant_bin[ 3630 ], 9, 1 );

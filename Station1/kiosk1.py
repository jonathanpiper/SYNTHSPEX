...
ALIVE = True
PATCH = 'SynthExhibit1-Waveforms12.pd'
...
libpd_subscribe('pyout_frequency')
...
inputFrequency = GetAnalogInput(6, "pyin_frequency", 1000)
inputAmplitude = GetAnalogInput(7, "pyin_amplitude", 1)

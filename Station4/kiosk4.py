...
ALIVE = True
PATCH = 'SynthExhibit4-Filter13.pd'
...
Station = StationBrain(4, Feedback, CardWriter)
...
inputCenterFrequency = GetAnalogInput(6, "pyin_center_frequency", 1950)
inputQuality = GetAnalogInput(7, "pyin_quality", 10)

    ...
    def readFromCard(self, uid):
        ...
        while station <= 6:
            ...
            for param in stationParameters:
                ...
                if bool(re.search('[-+]?[0-9]*\.?[0-9]+.', tmpdata[j*4:(j+1)*4])) == False:
                    print('Bad result for ' + param)
                    break
                try:
            ...
            if station > 2 and parameters['H03'] == 0 and parameters['H04'] == 0 and parameters['H05'] == 0 and parameters['H06'] == 0 and parameters['H07'] == 0 and parameters['H08'] == 0:
                libpd_float('hasVisited2', 0)
            station += 1
...
class StationFeedback(object):
    ...
    def up(self):
        ...
        for i in range (0, 101, 2):
            volume = float(i*VOLUME_MULTIPLIER)/100

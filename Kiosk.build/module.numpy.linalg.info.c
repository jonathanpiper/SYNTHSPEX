...
{
    const_str_digest_fc62ac7c06e1cf627e844d703ca23411 = UNSTREAM_STRING( &constant_bin[ 1857002 ], 26, 0 );
    const_str_digest_d25b2233d3d60db15b4e5188864fd678 = UNSTREAM_STRING( &constant_bin[ 1857028 ], 53, 0 );
    const_str_digest_02415e64e2eb2af89d58930190432cd8 = UNSTREAM_STRING( &constant_bin[ 1857010 ], 17, 0 );
    const_str_digest_89e693285590e79430d162136a6b4413 = UNSTREAM_STRING( &constant_bin[ 1857081 ], 1104, 0 );
...
static PyCodeObject *codeobj_f8586d60e683e188916e877e3620da53;

static void createModuleCodeObjects(void)
{
    module_filename_obj = const_str_digest_d25b2233d3d60db15b4e5188864fd678;
    codeobj_f8586d60e683e188916e877e3620da53 = MAKE_CODEOBJ( module_filename_obj, const_str_digest_fc62ac7c06e1cf627e844d703ca23411, 1, const_tuple_empty, 0, CO_NOFREE | CO_FUTURE_DIVISION | CO_FUTURE_ABSOLUTE_IMPORT | CO_FUTURE_PRINT_FUNCTION );
}
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_f8586d60e683e188916e877e3620da53;
    ...
    // Frame without reuse.
    frame_f8586d60e683e188916e877e3620da53 = MAKE_MODULE_FRAME( codeobj_f8586d60e683e188916e877e3620da53, module_numpy$linalg$info );

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack( frame_f8586d60e683e188916e877e3620da53 );
    assert( Py_REFCNT( frame_f8586d60e683e188916e877e3620da53 ) == 2 );
    ...
    // Tried code:
    {
        ...
        UPDATE_STRING_DICT1( moduledict_numpy$linalg$info, (Nuitka_StringObject *)const_str_plain_division, tmp_assign_source_4 );
    }
    {
        ...
        UPDATE_STRING_DICT1( moduledict_numpy$linalg$info, (Nuitka_StringObject *)const_str_plain_absolute_import, tmp_assign_source_5 );
    }
    {
        ...
        UPDATE_STRING_DICT1( moduledict_numpy$linalg$info, (Nuitka_StringObject *)const_str_plain_print_function, tmp_assign_source_6 );
    }
    goto try_end_1;
...
#if 0
    RESTORE_FRAME_EXCEPTION( frame_f8586d60e683e188916e877e3620da53 );
#endif
    popFrameStack();

    assertFrameObject( frame_f8586d60e683e188916e877e3620da53 );
    ...
    {
        exception_tb = MAKE_TRACEBACK( frame_f8586d60e683e188916e877e3620da53, exception_lineno );
    }
    else if ( exception_tb->tb_frame != &frame_f8586d60e683e188916e877e3620da53->m_frame )
    {
        exception_tb = ADD_TRACEBACK( exception_tb, frame_f8586d60e683e188916e877e3620da53, exception_lineno );
    }

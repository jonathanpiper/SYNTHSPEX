...
MOD_INIT_DECL( Adafruit_PN532 );
MOD_INIT_DECL( Adafruit_PN532$PN532 );
MOD_INIT_DECL( RPi );
MOD_INIT_DECL( RPi$GPIO );
MOD_INIT_DECL( __main__ );
MOD_INIT_DECL( apipkg );
MOD_INIT_DECL( apipkg$version );
...
MOD_INIT_DECL( mpmath$calculus );
MOD_INIT_DECL( mpmath$calculus$approximation );
MOD_INIT_DECL( mpmath$calculus$calculus );
MOD_INIT_DECL( mpmath$calculus$differentiation );
MOD_INIT_DECL( mpmath$calculus$extrapolation );
MOD_INIT_DECL( mpmath$calculus$inverselaplace );
MOD_INIT_DECL( mpmath$calculus$odes );
MOD_INIT_DECL( mpmath$calculus$optimization );
MOD_INIT_DECL( mpmath$calculus$polynomials );
MOD_INIT_DECL( mpmath$calculus$quadrature );
MOD_INIT_DECL( mpmath$ctx_base );
MOD_INIT_DECL( mpmath$ctx_fp );
MOD_INIT_DECL( mpmath$ctx_iv );
MOD_INIT_DECL( mpmath$ctx_mp );
MOD_INIT_DECL( mpmath$ctx_mp_python );
MOD_INIT_DECL( mpmath$function_docs );
MOD_INIT_DECL( mpmath$functions );
MOD_INIT_DECL( mpmath$functions$bessel );
MOD_INIT_DECL( mpmath$functions$elliptic );
MOD_INIT_DECL( mpmath$functions$expintegrals );
MOD_INIT_DECL( mpmath$functions$factorials );
MOD_INIT_DECL( mpmath$functions$functions );
MOD_INIT_DECL( mpmath$functions$hypergeometric );
MOD_INIT_DECL( mpmath$functions$orthogonal );
MOD_INIT_DECL( mpmath$functions$qfunctions );
MOD_INIT_DECL( mpmath$functions$rszeta );
MOD_INIT_DECL( mpmath$functions$theta );
MOD_INIT_DECL( mpmath$functions$zeta );
MOD_INIT_DECL( mpmath$functions$zetazeros );
MOD_INIT_DECL( mpmath$identification );
MOD_INIT_DECL( mpmath$libmp );
MOD_INIT_DECL( mpmath$libmp$backend );
MOD_INIT_DECL( mpmath$libmp$gammazeta );
MOD_INIT_DECL( mpmath$libmp$libelefun );
MOD_INIT_DECL( mpmath$libmp$libhyper );
MOD_INIT_DECL( mpmath$libmp$libintmath );
MOD_INIT_DECL( mpmath$libmp$libmpc );
MOD_INIT_DECL( mpmath$libmp$libmpf );
MOD_INIT_DECL( mpmath$libmp$libmpi );
MOD_INIT_DECL( mpmath$libmp$six );
MOD_INIT_DECL( mpmath$math2 );
MOD_INIT_DECL( mpmath$matrices );
MOD_INIT_DECL( mpmath$matrices$calculus );
MOD_INIT_DECL( mpmath$matrices$eigen );
MOD_INIT_DECL( mpmath$matrices$eigen_symmetric );
MOD_INIT_DECL( mpmath$matrices$linalg );
MOD_INIT_DECL( mpmath$matrices$matrices );
MOD_INIT_DECL( mpmath$rational );
MOD_INIT_DECL( mpmath$tests );
MOD_INIT_DECL( mpmath$tests$runtests );
MOD_INIT_DECL( mpmath$usertools );
MOD_INIT_DECL( mpmath$visualization );
MOD_INIT_DECL( numpy );
...
MOD_INIT_DECL( py$_vendored_packages$apipkg );
MOD_INIT_DECL( py$_version );
MOD_INIT_DECL( pyaudio );
MOD_INIT_DECL( pylibpd );
MOD_INIT_DECL( six );
MOD_INIT_DECL( synthlibrary );
static struct Nuitka_MetaPathBasedLoaderEntry meta_path_loader_entries[] =
{
    { "Adafruit_GPIO", MOD_INIT_NAME( Adafruit_GPIO ), 0, 0, NUITKA_PACKAGE_FLAG },
    { "Adafruit_GPIO.GPIO", MOD_INIT_NAME( Adafruit_GPIO$GPIO ), 0, 0, NUITKA_COMPILED_MODULE },
    { "Adafruit_GPIO.Platform", MOD_INIT_NAME( Adafruit_GPIO$Platform ), 0, 0, NUITKA_COMPILED_MODULE },
    { "Adafruit_GPIO.SPI", MOD_INIT_NAME( Adafruit_GPIO$SPI ), 0, 0, NUITKA_COMPILED_MODULE },
    { "Adafruit_PN532", MOD_INIT_NAME( Adafruit_PN532 ), 0, 0, NUITKA_PACKAGE_FLAG },
    { "Adafruit_PN532.PN532", MOD_INIT_NAME( Adafruit_PN532$PN532 ), 0, 0, NUITKA_COMPILED_MODULE },
    { "RPi", MOD_INIT_NAME( RPi ), 0, 0, NUITKA_PACKAGE_FLAG },
    { "RPi.GPIO", MOD_INIT_NAME( RPi$GPIO ), 0, 0, NUITKA_PACKAGE_FLAG },
    { "__main__", MOD_INIT_NAME( __main__ ), 0, 0, NUITKA_COMPILED_MODULE },
    { "apipkg", MOD_INIT_NAME( apipkg ), 0, 0, NUITKA_PACKAGE_FLAG },
    { "apipkg.version", MOD_INIT_NAME( apipkg$version ), 0, 0, NUITKA_COMPILED_MODULE },
    ...
    { "backports.configparser.helpers", MOD_INIT_NAME( backports$configparser$helpers ), 0, 0, NUITKA_COMPILED_MODULE },
    { "configparser", MOD_INIT_NAME( configparser ), 0, 0, NUITKA_COMPILED_MODULE },
    { "mpmath", MOD_INIT_NAME( mpmath ), 0, 0, NUITKA_PACKAGE_FLAG },
    { "mpmath.calculus", MOD_INIT_NAME( mpmath$calculus ), 0, 0, NUITKA_PACKAGE_FLAG },
    { "mpmath.calculus.approximation", MOD_INIT_NAME( mpmath$calculus$approximation ), 0, 0, NUITKA_COMPILED_MODULE },
    { "mpmath.calculus.calculus", MOD_INIT_NAME( mpmath$calculus$calculus ), 0, 0, NUITKA_COMPILED_MODULE },
    { "mpmath.calculus.differentiation", MOD_INIT_NAME( mpmath$calculus$differentiation ), 0, 0, NUITKA_COMPILED_MODULE },
    { "mpmath.calculus.extrapolation", MOD_INIT_NAME( mpmath$calculus$extrapolation ), 0, 0, NUITKA_COMPILED_MODULE },
    { "mpmath.calculus.inverselaplace", MOD_INIT_NAME( mpmath$calculus$inverselaplace ), 0, 0, NUITKA_COMPILED_MODULE },
    { "mpmath.calculus.odes", MOD_INIT_NAME( mpmath$calculus$odes ), 0, 0, NUITKA_COMPILED_MODULE },
    { "mpmath.calculus.optimization", MOD_INIT_NAME( mpmath$calculus$optimization ), 0, 0, NUITKA_COMPILED_MODULE },
    { "mpmath.calculus.polynomials", MOD_INIT_NAME( mpmath$calculus$polynomials ), 0, 0, NUITKA_COMPILED_MODULE },
    { "mpmath.calculus.quadrature", MOD_INIT_NAME( mpmath$calculus$quadrature ), 0, 0, NUITKA_COMPILED_MODULE },
    { "mpmath.ctx_base", MOD_INIT_NAME( mpmath$ctx_base ), 0, 0, NUITKA_COMPILED_MODULE },
    { "mpmath.ctx_fp", MOD_INIT_NAME( mpmath$ctx_fp ), 0, 0, NUITKA_COMPILED_MODULE },
    { "mpmath.ctx_iv", MOD_INIT_NAME( mpmath$ctx_iv ), 0, 0, NUITKA_COMPILED_MODULE },
    { "mpmath.ctx_mp", MOD_INIT_NAME( mpmath$ctx_mp ), 0, 0, NUITKA_COMPILED_MODULE },
    { "mpmath.ctx_mp_python", MOD_INIT_NAME( mpmath$ctx_mp_python ), 0, 0, NUITKA_COMPILED_MODULE },
    { "mpmath.function_docs", MOD_INIT_NAME( mpmath$function_docs ), 0, 0, NUITKA_COMPILED_MODULE },
    { "mpmath.functions", MOD_INIT_NAME( mpmath$functions ), 0, 0, NUITKA_PACKAGE_FLAG },
    { "mpmath.functions.bessel", MOD_INIT_NAME( mpmath$functions$bessel ), 0, 0, NUITKA_COMPILED_MODULE },
    { "mpmath.functions.elliptic", MOD_INIT_NAME( mpmath$functions$elliptic ), 0, 0, NUITKA_COMPILED_MODULE },
    { "mpmath.functions.expintegrals", MOD_INIT_NAME( mpmath$functions$expintegrals ), 0, 0, NUITKA_COMPILED_MODULE },
    { "mpmath.functions.factorials", MOD_INIT_NAME( mpmath$functions$factorials ), 0, 0, NUITKA_COMPILED_MODULE },
    { "mpmath.functions.functions", MOD_INIT_NAME( mpmath$functions$functions ), 0, 0, NUITKA_COMPILED_MODULE },
    { "mpmath.functions.hypergeometric", MOD_INIT_NAME( mpmath$functions$hypergeometric ), 0, 0, NUITKA_COMPILED_MODULE },
    { "mpmath.functions.orthogonal", MOD_INIT_NAME( mpmath$functions$orthogonal ), 0, 0, NUITKA_COMPILED_MODULE },
    { "mpmath.functions.qfunctions", MOD_INIT_NAME( mpmath$functions$qfunctions ), 0, 0, NUITKA_COMPILED_MODULE },
    { "mpmath.functions.rszeta", MOD_INIT_NAME( mpmath$functions$rszeta ), 0, 0, NUITKA_COMPILED_MODULE },
    { "mpmath.functions.theta", MOD_INIT_NAME( mpmath$functions$theta ), 0, 0, NUITKA_COMPILED_MODULE },
    { "mpmath.functions.zeta", MOD_INIT_NAME( mpmath$functions$zeta ), 0, 0, NUITKA_COMPILED_MODULE },
    { "mpmath.functions.zetazeros", MOD_INIT_NAME( mpmath$functions$zetazeros ), 0, 0, NUITKA_COMPILED_MODULE },
    { "mpmath.identification", MOD_INIT_NAME( mpmath$identification ), 0, 0, NUITKA_COMPILED_MODULE },
    { "mpmath.libmp", MOD_INIT_NAME( mpmath$libmp ), 0, 0, NUITKA_PACKAGE_FLAG },
    { "mpmath.libmp.backend", MOD_INIT_NAME( mpmath$libmp$backend ), 0, 0, NUITKA_COMPILED_MODULE },
    { "mpmath.libmp.gammazeta", MOD_INIT_NAME( mpmath$libmp$gammazeta ), 0, 0, NUITKA_COMPILED_MODULE },
    { "mpmath.libmp.libelefun", MOD_INIT_NAME( mpmath$libmp$libelefun ), 0, 0, NUITKA_COMPILED_MODULE },
    { "mpmath.libmp.libhyper", MOD_INIT_NAME( mpmath$libmp$libhyper ), 0, 0, NUITKA_COMPILED_MODULE },
    { "mpmath.libmp.libintmath", MOD_INIT_NAME( mpmath$libmp$libintmath ), 0, 0, NUITKA_COMPILED_MODULE },
    { "mpmath.libmp.libmpc", MOD_INIT_NAME( mpmath$libmp$libmpc ), 0, 0, NUITKA_COMPILED_MODULE },
    { "mpmath.libmp.libmpf", MOD_INIT_NAME( mpmath$libmp$libmpf ), 0, 0, NUITKA_COMPILED_MODULE },
    { "mpmath.libmp.libmpi", MOD_INIT_NAME( mpmath$libmp$libmpi ), 0, 0, NUITKA_COMPILED_MODULE },
    { "mpmath.libmp.six", MOD_INIT_NAME( mpmath$libmp$six ), 0, 0, NUITKA_COMPILED_MODULE },
    { "mpmath.math2", MOD_INIT_NAME( mpmath$math2 ), 0, 0, NUITKA_COMPILED_MODULE },
    { "mpmath.matrices", MOD_INIT_NAME( mpmath$matrices ), 0, 0, NUITKA_PACKAGE_FLAG },
    { "mpmath.matrices.calculus", MOD_INIT_NAME( mpmath$matrices$calculus ), 0, 0, NUITKA_COMPILED_MODULE },
    { "mpmath.matrices.eigen", MOD_INIT_NAME( mpmath$matrices$eigen ), 0, 0, NUITKA_COMPILED_MODULE },
    { "mpmath.matrices.eigen_symmetric", MOD_INIT_NAME( mpmath$matrices$eigen_symmetric ), 0, 0, NUITKA_COMPILED_MODULE },
    { "mpmath.matrices.linalg", MOD_INIT_NAME( mpmath$matrices$linalg ), 0, 0, NUITKA_COMPILED_MODULE },
    { "mpmath.matrices.matrices", MOD_INIT_NAME( mpmath$matrices$matrices ), 0, 0, NUITKA_COMPILED_MODULE },
    { "mpmath.rational", MOD_INIT_NAME( mpmath$rational ), 0, 0, NUITKA_COMPILED_MODULE },
    { "mpmath.tests", MOD_INIT_NAME( mpmath$tests ), 0, 0, NUITKA_PACKAGE_FLAG },
    { "mpmath.tests.runtests", MOD_INIT_NAME( mpmath$tests$runtests ), 0, 0, NUITKA_COMPILED_MODULE },
    { "mpmath.usertools", MOD_INIT_NAME( mpmath$usertools ), 0, 0, NUITKA_COMPILED_MODULE },
    { "mpmath.visualization", MOD_INIT_NAME( mpmath$visualization ), 0, 0, NUITKA_COMPILED_MODULE },
    ...
    { "numpy.distutils", NULL, 2444704, 1333, NUITKA_BYTECODE_FLAG | NUITKA_PACKAGE_FLAG },
    { "numpy.distutils.__config__", NULL, 2446037, 2347, NUITKA_BYTECODE_FLAG },
    { "numpy.distutils.__version__", NULL, 2448384, 393, NUITKA_BYTECODE_FLAG },
    { "numpy.distutils.ccompiler", NULL, 2448777, 24273, NUITKA_BYTECODE_FLAG },
    { "numpy.distutils.compat", NULL, 2473050, 580, NUITKA_BYTECODE_FLAG },
    { "numpy.distutils.cpuinfo", NULL, 2473630, 43844, NUITKA_BYTECODE_FLAG },
    { "numpy.distutils.exec_command", NULL, 2517474, 11117, NUITKA_BYTECODE_FLAG },
    { "numpy.distutils.info", NULL, 2528591, 378, NUITKA_BYTECODE_FLAG },
    { "numpy.distutils.log", NULL, 2528969, 3083, NUITKA_BYTECODE_FLAG },
    { "numpy.distutils.misc_util", NULL, 2532052, 78466, NUITKA_BYTECODE_FLAG },
    { "numpy.distutils.npy_pkg_config", NULL, 2610518, 15172, NUITKA_BYTECODE_FLAG },
    { "numpy.distutils.unixccompiler", NULL, 2625690, 4133, NUITKA_BYTECODE_FLAG },
    ...
    { "numpy.testing", NULL, 2629823, 935, NUITKA_BYTECODE_FLAG | NUITKA_PACKAGE_FLAG },
    { "numpy.testing._private", NULL, 2630758, 146, NUITKA_BYTECODE_FLAG | NUITKA_PACKAGE_FLAG },
    { "numpy.testing._private.decorators", NULL, 2630904, 10533, NUITKA_BYTECODE_FLAG },
    { "numpy.testing._private.nosetester", NULL, 2641437, 17226, NUITKA_BYTECODE_FLAG },
    { "numpy.testing._private.utils", NULL, 2658663, 73978, NUITKA_BYTECODE_FLAG },
    { "numpy.version", MOD_INIT_NAME( numpy$version ), 0, 0, NUITKA_COMPILED_MODULE },
    { "pkg_resources", NULL, 2732641, 119050, NUITKA_BYTECODE_FLAG | NUITKA_PACKAGE_FLAG },
    { "pkg_resources._vendor", NULL, 2851691, 145, NUITKA_BYTECODE_FLAG | NUITKA_PACKAGE_FLAG },
    { "pkg_resources._vendor.appdirs", NULL, 2851836, 23144, NUITKA_BYTECODE_FLAG },
    { "pkg_resources._vendor.packaging", NULL, 2874980, 606, NUITKA_BYTECODE_FLAG | NUITKA_PACKAGE_FLAG },
    { "pkg_resources._vendor.packaging.__about__", NULL, 2875586, 784, NUITKA_BYTECODE_FLAG },
    { "pkg_resources._vendor.packaging._compat", NULL, 2876370, 1248, NUITKA_BYTECODE_FLAG },
    { "pkg_resources._vendor.packaging._structures", NULL, 2877618, 4228, NUITKA_BYTECODE_FLAG },
    { "pkg_resources._vendor.packaging.markers", NULL, 2881846, 12059, NUITKA_BYTECODE_FLAG },
    { "pkg_resources._vendor.packaging.requirements", NULL, 2893905, 5189, NUITKA_BYTECODE_FLAG },
    { "pkg_resources._vendor.packaging.specifiers", NULL, 2899094, 25532, NUITKA_BYTECODE_FLAG },
    { "pkg_resources._vendor.packaging.version", NULL, 2924626, 14581, NUITKA_BYTECODE_FLAG },
    { "pkg_resources._vendor.pyparsing", NULL, 2939207, 236618, NUITKA_BYTECODE_FLAG },
    { "pkg_resources._vendor.six", NULL, 3175825, 31846, NUITKA_BYTECODE_FLAG },
    { "pkg_resources.extern", NULL, 3207671, 2939, NUITKA_BYTECODE_FLAG | NUITKA_PACKAGE_FLAG },
    { "pkg_resources.py31compat", NULL, 3210610, 750, NUITKA_BYTECODE_FLAG },
    { "py", MOD_INIT_NAME( py ), 0, 0, NUITKA_PACKAGE_FLAG },
    { "py._error", MOD_INIT_NAME( py$_error ), 0, 0, NUITKA_COMPILED_MODULE },
    { "py._vendored_packages", MOD_INIT_NAME( py$_vendored_packages ), 0, 0, NUITKA_PACKAGE_FLAG },
    { "py._vendored_packages.apipkg", MOD_INIT_NAME( py$_vendored_packages$apipkg ), 0, 0, NUITKA_COMPILED_MODULE },
    { "py._version", MOD_INIT_NAME( py$_version ), 0, 0, NUITKA_COMPILED_MODULE },
    { "pyaudio", MOD_INIT_NAME( pyaudio ), 0, 0, NUITKA_COMPILED_MODULE },
    { "pylibpd", MOD_INIT_NAME( pylibpd ), 0, 0, NUITKA_COMPILED_MODULE },
    { "six", MOD_INIT_NAME( six ), 0, 0, NUITKA_COMPILED_MODULE },
    { "synthlibrary", MOD_INIT_NAME( synthlibrary ), 0, 0, NUITKA_COMPILED_MODULE },
    { NULL, NULL, 0, 0, 0 }
};
